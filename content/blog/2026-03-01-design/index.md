...
The climate goal is a tough one, made all the harder because I'm not using a 100% renewable web host---despite how much I love Reclaim Hosting, I am pondering a relocation. Yet the reduction of file sizes, DOM elements on the page, minimizing energy emitted by your device when visiting my site, and web-friendly images all have a positive impact. I'm not quite hitting my 0.185g goal, but I did significantly reduce what this site was measuring before the redesign: I cut this by nearly 82% just in these changes alone.
