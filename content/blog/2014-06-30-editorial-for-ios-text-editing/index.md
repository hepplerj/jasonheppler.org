...
![Previewing the Markdown of this document](markdown_preview.webp)
...
![The left-side navigation of Editorial](navigation.webp)
...
![They keyboard interface includes access to undo, snippets, and common Markdown characters](keyboard.webp) 
...
![Comparison between the light and dark theme](theme_compare.webp)

## Snippets

![The list of snippets installed in my Editorial](snippet_list.webp)
...
![The auto-complete bubbles for snippets](snippet_bubble.webp)
...
![Viewing the list of versions in Editorial](version_list.webp)
...
![TaskPaper mode in Editorial allows for plain text task management](taskpaper.webp)
...
![Previewing the iPhone home screen icon, text editing pane, and navigation pane](iPhone_preview.webp)

## Workflows

I hope I've made the case that, up to this point, Editorial is already incredibly useful and powerful. But it gets better.

![The user interface for building Workflows](workflow_view.webp)
...
![Accessing all installed Workflows from the wrench icon](workflow_list_editorial.webp)
