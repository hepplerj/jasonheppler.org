...
![The overall view of Editorial for iPad](/assets/images/overall.webp)
...
![Previewing the Markdown of this document](/assets/images/markdown_preview.webp)
...
![The left-side navigation of Editorial](/assets/images/navigation.webp)
...
![They keyboard interface includes access to undo, snippets, and common Markdown characters](/assets/images/keyboard.webp) 
...
![Comparison between the light and dark theme](/assets/images/theme_compare.webp)

## Snippets

![The list of snippets installed in my Editorial](/assets/images/snippet_list.webp)
...
![The auto-complete bubbles for snippets](/assets/images/snippet_bubble.webp)
...
![Viewing the list of versions in Editorial](/assets/images/version_list.webp)
...
![TaskPaper mode in Editorial allows for plain text task management](/assets/images/taskpaper.webp)
...
![Previewing the iPhone home screen icon, text editing pane, and navigation pane](/assets/images/iPhone_preview.webp)

## Workflows

I hope I've made the case that, up to this point, Editorial is already incredibly useful and powerful. But it gets better.

![The user interface for building Workflows](/assets/images/workflow_view.webp)
...
![Accessing all installed Workflows from the wrench icon](/assets/images/workflow_list_editorial.webp)
