...
<details>
  ...
  <ul>
   <li>"What Do you Mean by Archive? Genres of Usage for Digital Preservers," February 27, 2014, by Trevor Owens</li>
  ...
  <ul>
  <li>"It's All About the Stuff: Collections, Interfaces, Power, and People," by Tim Sherratt</li>
  <li>"Generous Interfaces for Digital Cultural Collections," by Mitchell Whitelaw</li>
  <li><strong>Activity:</strong> Build a collection in Omeka</li>
  </ul>
  <h3>Assignments</h3>
  <ul>
   <li>Major Assignment: Personas Revised</li>
   <li>Major Assignment: Project Proposal</li>
  </ul>
</details>
</div>
...
<details>
  ...
  <ul>
  <li>"Telling an Old Story in a New Way: Raid on Deerfield, The Many Stories of 1704," by Lynne Spichiger and Juliet Jacobson</li>
  <li>"Eavesdropping at the Well: Interpretive Media in the Slavery in New York Exhibition," by Richard Rabinowitz</li>
  <li><strong>Activity:</strong> Explore Sites</li>
  </ul>
  <h3>Reading and Activities: Storyboarding</h3>
  <ul>
  <li>"The Curator Rules," by Steven Lubar</li>
  <li>"Exhibit and Exhibit Labels Workshop," by Steven Lubar</li>
  <li>"Paper Prototyping," by Shawn Medero</li>
  <li><strong>Activity:</strong> StoryBoarding</li>
  </ul>
  <h3>Reading and Activities: Content</h3>
  <ul>
   <li>"Developing Your Synthetic Powers," by Suzanne Fischer</li>
   <li>"A Checklist for Content Work," by Erin Kissane</li>
   <li><strong>Activity:</strong> Content Templates</li>
  </ul>
  <h3>Assignments</h3>
  <ul>
   <li>Building your DPH project infrastructure</li>
  </ul>
</details>
</div>
...
<details>
  ...
  <ul>
   ...
   <li>"Harvesting History, Remembering Rondo," by Marvin Anderson and Rebecca Wingo</li>
   <li>"OutHistory.org: An Experiment in LGBTQ Community History-Making," by Lauren Jae Gutterman</li>
   <li><strong>Activity:</strong> Digital Communities</li>
   <li><strong>Activity:</strong> Explore Sites</li>
  </ul>
  <h3>Assignments</h3>
  <ul>
...
<details>
  ...
  <li>"Designing a National Online Oral History Collecting Initiative: The Occupational Folklore Project at the American Folklife Center," by Nancy Groce and Bertram Lyons</li>
  <li><strong>Activity:</strong> Explore Sites</li>
  <li><strong>Activity:</strong> Annotating Oral History</li>
  </ul>
  <h3>Assignments</h3>
  <ul>
   <li>Project Progress Update</li>
...
<details>
  ...
  <ul>
   ...
   <li>"World War One: Love and Sorrow: A hybrid exhibition mobile experience," by Timothy Hart and Jonny Brownbill</li>
   <li>"Beyond the Screen: Creating interactives that are location, time, preference, and skill responsive," by Brad Baer, Emily Fry, and Daniel Davis</li>
   <li>"Listening to the City: Oral History and Place in the Digital Era," by Mark Tebeau</li>
   <li><strong>Activity:</strong> Explore Sites</li>
   <li><strong>Activity:</strong> Exploring your landscape with digital public history</li>
  </ul>
  <h3>Assignments</h3>
  <ul>
   <li>Project Progress Update</li>
...
<details>
  ...
  <li>Creativity and how to use yours</li>
  <li>Pitching an Episode</li>
  <li>Sample Podcast</li>
  <li>"Podcasting Public History: Comparing Throughline and Backstory," by Allison Horrocks</li>
  <li><strong>Activity:</strong> Pitch your Podcast</li>
  </ul>
  <h3>Assignments</h3>
  <ul>
   <li>Project Progress update</li>
   <li>Portfolio blog post 2</li>
  </ul>
</details>
</div>
...
<details>
  ...
  <ul>
   ...
   <li>Explore IMLS Evaluation Resources</li>
   <li>"Testing Content," by Angela Colter</li>
   <li><strong>Activity:</strong> Draft an evaluation plan for your project</li>
  </ul>
  <h3>Assignments</h3>
  <ul>
   <li>Portfolio blog post 3</li>
  </ul>
</details>
</div>
...
<details>
  ...
  <ul>
   ...
   <li>Review Prototype Material</li>
  </ul>
  <h3>Assignments</h3>
  <ul>
   <li>Pitch Video or Screencast</li>
  </ul>
</details>
</div>
