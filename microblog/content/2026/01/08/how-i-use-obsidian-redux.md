...
microblog: false
guid: http://jaheppler.micro.blog/2026/01/08/how-i-use-obsidian-redux/
post_id: 5702718
custom_summary: true
summary: "An update on how I use Obsidian for historical research."
...
- "Longform"
images:
- https://cdn.uploads.micro.blog/2634/2025/screenshot-2025-12-16-at-8.55.47am.png
- https://cdn.uploads.micro.blog/2634/2025/screenshot-2025-12-16-at-8.55.53am.png
- https://cdn.uploads.micro.blog/2634/2025/screenshot-2025-12-23-at-8.38.56am.png
photos:
photos_with_metadata:
url: "/2026/01/08/how-i-use-obsidian-redux/"
---
A little over a year ago [I wrote about](https://writing.jasonheppler.org/2024/07/15/how-i-use-obsidian/) how I use Obsidian for historical research. While it hasn't changed substantially since I wrote that piece, there are some updates to the system I'd been wanting to write up. An email from a friend with questions about that piece, and this is basically the email I wrote back to him.
...
<img src="uploads/2025/screenshot-2025-12-16-at-8.55.47am.png" width="600" height="390" alt="Obsidian displays metadata for a letter sent from Sherlock and Kleckner to Bush on November 30, 1988, including properties like author, recipient, and location.">
...
<img src="uploads/2025/screenshot-2025-12-16-at-8.55.53am.png" width="600" height="390" alt="A letter addressed to then-Governor George Bush from the Coalition for Fiscal Responsability is displayed on a computer screen, with a network graph and file directory visible on the left side.">
...
<img src="uploads/2025/screenshot-2025-12-23-at-8.38.56am.png" width="600" height="379" alt="Obsidian Bases showing a chronologically sorted list of correspondence.">
