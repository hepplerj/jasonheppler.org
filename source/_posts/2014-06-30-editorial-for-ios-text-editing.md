...
![The overall view of Editorial for iPad](/assets/img/overall.png)
...
![Previewing the Markdown of this document](/assets/img/markdown_preview.png)
...
![The left-side navigation of Editorial](/assets/img/navigation.png)
...
![They keyboard interface includes access to undo, snippets, and common Markdown characters](/assets/img/keyboard.png) 
...
![Comparison between the light and dark theme](/assets/img/theme_compare.png)

## Snippets

![The list of snippets installed in my Editorial](/assets/img/snippet_list.png)
...
![The auto-complete bubbles for snippets](/assets/img/snippet_bubble.png)
...
![Viewing the list of versions in Editorial](/assets/img/version_list.png)
...
![TaskPaper mode in Editorial allows for plain text task management](/assets/img/taskpaper.png)
...
![Previewing the iPhone home screen icon, text editing pane, and navigation pane](/assets/img/iPhone_preview.png)

## Workflows

I hope I've made the case that, up to this point, Editorial is already incredibly useful and powerful. But it gets better.

![The user interface for building Workflows](/assets/img/workflow_view.png)
...
![Accessing all installed Workflows from the wrench icon](/assets/img/workflow_list_editorial.png)
